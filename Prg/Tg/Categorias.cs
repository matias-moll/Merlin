...
namespace Mrln.Tg
{
    ...
    // Sistema                   : Mrln
    // Interface para la Entidad : Categoria
    ...
    /// <summary>
    /// Formulario para Mantenimiento de la Tabla:Categorias
    /// </summary>
    public partial class Categorias : DockContent
    {
        #region Miembros de la Clase
            private Bel.ECategoria m_entCategoria= null;
        ...
        private void grdDatos_HeaderClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left) {
                ...
                if (m_strSort != grdDatos.GridOrder) {
                    ...
                    App.SetStrURegistry(false, "GridFormat", "CategoriasGrdSort", m_strSort);
                    return;
                }
            }
        ...
        private void GrdColumn_WidthChanged(object sender, EventArgs e)
        {
            ...
            App.SetStrURegistry(false, "GridFormat", "CategoriasGrdWidths", grdDatos.ColWitdhs);
        }
        ...
        private void gbExcel_Click(object sender, System.EventArgs e)
        {
            ...
            grdDatos.ExportToExcel(false, false, "", "Categorias", m_smResult);
            App.EndAdvance();
            App.HideMsg();
        }
        ...
        private void gbNuevo_Click(object sender, System.EventArgs e)
        {
            ...
            m_entCategoria.Cod = Bll.Tablas.CatNextKey(m_smResult);
            m_smResult.Reset();
        ...
        private void gbModificar_Click(object sender, System.EventArgs e)
        {
            ...
            m_entCategoria= Bll.Tablas.CatGet((string) grdDatos.GetMatrixValueObj(l_iRow, 1),
                                              false, m_smResult);
        ...
        private void gbCompactar_Click(object sender, EventArgs e)
        {
            ...
            if (MsgRuts.AskUser(this, "Atención!!!!\r\n" +
                                      ...
                                      /*App.Usuario.Usuario +*/ "CategoriasPurge") == DialogResult.No) return;

            // Purgamos la tabla
            App.ShowMsg("Compactando la tabla...");
            Bll.Tablas.CatPurge(m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void gbChangeHabilitado_Click(object sender, System.EventArgs e)
        {
            ...
            Bll.Tablas.CatEnabled(m_entCategoria.EstaBorrada,
                                  m_entCategoria.Cod,
                                  m_entCategoria.FxdVersion,
                                  m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void gbGrabar_Click(object sender, System.EventArgs e)
        {
            ...
            m_entCategoria.Cod= txtCod.Text;
            m_entCategoria.Des= txtDes.Text;

            // Tratamos de grabar la entidad
            App.ShowMsg("Grabando...");
            Bll.Tablas.CatSave(m_entCategoria, m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void FillGrid()
        {
            ...
            grdDatos.Focus();
            grdDatos.FillFromLEntidad(l_lentCategorias, "deleted");
            grdDatos.ColWitdhs= App.GetStrURegistry(false, "GridFormat", "CategoriasGrdWidths", "");
            grdDatos.GridOrder= App.GetStrURegistry(false, "GridFormat", "CategoriasGrdSort", "");
            App.EndAdvance();

            // Fijamos el evento de cambio de ancho de la grilla
            if (l_lentCategorias.Count > 0)
        ...
        private void EditMode()
        {
            ...
            txtCod.Text= m_entCategoria.Cod;
            txtDes.Text= m_entCategoria.Des;
            ...
            cmdGrabar.Enabled= !m_entCategoria.EstaBorrada;
            gbDeshabilitar.Enabled= ((!m_entCategoria.EsNueva) &&(!m_entCategoria.EstaBorrada));
