    ...
    public static class Categorias
    {
                                      ...
                                      StatMsg p_smResult)
        {
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Mrln..CATEGORIAS_CHKVERSION",
                               new DbParameter[] {
                                     ...
                                     StatMsg p_smResult)
        {
            ...
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Mrln..CATEGORIAS_GETMAXKEY",
                               new DbParameter[] {
                                    ...
                                    StatMsg p_smResult)
        {
            try {
                return DBRuts.Exec_DS(p_dbcAccess,
                                      "TNGS_Mrln..CATEGORIAS_GETBYDESC",
                                      new DbParameter[] {
                                            ...
                                            StatMsg p_smResult)
        {
            try {
                ...
                p_dtResult.Columns["cat_rcd_cod"].Caption= "V1Cod CategoriaCN1";
                p_dtResult.Columns["cat_des_des"].Caption= "V1CategoriaCN1";
