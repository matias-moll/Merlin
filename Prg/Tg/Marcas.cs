...
namespace Rivn.Tg
{
    ...
    // Sistema                   : Rivn
    // Interface para la Entidad : Marca
    ...
    /// <summary>
    /// Formulario para Mantenimiento de la Tabla:Marcas
    /// </summary>
    public partial class Marcas : DockContent
    {
        #region Miembros de la Clase
            private Bel.EMarca m_entMarca= null;
        ...
        /// </summary>
        private void Marcas_Load(object sender, System.EventArgs e)
        {
        ...
        private void grdDatos_HeaderClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left) {
                ...
                if (m_strSort != grdDatos.GridOrder) {
                    ...
                    App.SetStrURegistry(false, "GridFormat", "MarcasGrdSort", m_strSort);
                    return;
                }
            }
        ...
        private void GrdColumn_WidthChanged(object sender, EventArgs e)
        {
            ...
            App.SetStrURegistry(false, "GridFormat", "MarcasGrdWidths", grdDatos.ColWitdhs);
        }
        ...
        private void cmdPurgar_Click(object sender, EventArgs e)
        {
            ...
            if (MsgRuts.AskUser(this, "Atención!!!!\r\n" +
                                      ...
                                      /*App.Usuario.Usuario +*/ "MarcasPurge") == DialogResult.No) return;
        ...
        private void cmdGrabar_Click(object sender, System.EventArgs e)
        {
            ...
            m_entMarca.Codigo= txtCodigo.Text;
            m_entMarca.Descripcion= txtDescripcion.Text;
        ...
        private void FillGrid()
        {
            ...
            grdDatos.Focus();
            grdDatos.FillFromLEntidad(l_lentMarcas, "deleted");
            grdDatos.ColWitdhs= App.GetStrURegistry(false, "GridFormat", "MarcasGrdWidths", "");
            grdDatos.GridOrder= App.GetStrURegistry(false, "GridFormat", "MarcasGrdSort", "");
            App.EndAdvance();

            // Fijamos el evento de cambio de ancho de la grilla
            if (l_lentMarcas.Count > 0)
        ...
        private void EditMode()
        {
            ...
            txtCodigo.Text= m_entMarca.Codigo;
            txtDescripcion.Text= m_entMarca.Descripcion;

            // Habilitamos el frame
            txtCodigo.NormalDisable= false;
            txtCodigo.Enabled= m_entMarca.EsNueva;
            txtDescripcion.NormalDisable= false;
            txtDescripcion.Enabled= m_entMarca.EsNueva;
            cmdCancelar.Enabled= true;
            cmdGrabar.Enabled= !m_entMarca.EstaBorrada;
            cmdDesHab.Enabled= ((!m_entMarca.EsNueva) &&(!m_entMarca.EstaBorrada));
