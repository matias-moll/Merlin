...
namespace Mrln.Tg
{
    ...
    public partial class DestinatariosMails : DockContent
    {
        ...
        private void cmdExcel_Click(object sender, System.EventArgs e)
        {
            ...
            grdDatos.ExportToExcel(false, false, "", "DestinatariosMails", ref m_smResult);
            App.EndAdvance();
            App.HideMsg();
        }
        ...
        private void cmdPurgar_Click(object sender, EventArgs e)
        {
            ...
            Bll.Tablas.DemPurge(ref m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void cmdGrabar_Click(object sender, System.EventArgs e)
        {
            ...
            Bll.Tablas.DemSave(m_entDestinatariosMail, ref m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void FillGrid()
        {
            ...
            App.ShowMsg("Recuperando datos...");
            Bel.LEDestinatariosMails l_lentDestinatariosMails= Bll.Tablas.DemUpFull(false, ref m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void EditMode()
        {
            ...
            cmdDesHab.Enabled= ((!m_entDestinatariosMail.EsNueva) &&(!m_entDestinatariosMail.EstaBorrada));
