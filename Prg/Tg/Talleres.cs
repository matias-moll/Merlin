...
namespace Mrln.Tg
{
    ...
    public partial class Talleres : DockContent
    {
        ...
        private void gbExcel_Click(object sender, System.EventArgs e)
        {
            ...
            grdDatos.ExportToExcel(false, false, "", "Talleres", m_smResult);
            App.EndAdvance();
            App.HideMsg();
        }
        ...
        private void gbNuevo_Click(object sender, System.EventArgs e)
        {
            ...
            m_entTaller.Codigo = Bll.Talleres.NextKey(m_smResult);
            m_smResult.Reset();
        ...
        private void gbGrabar_Click(object sender, System.EventArgs e)
        {
            ...
            Bll.Talleres.Save(m_entTaller, m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void EditMode()
        {
            ...
            gbDeshabilitar.Enabled= ((!m_entTaller.EsNueva) &&(!m_entTaller.EstaBorrada));
