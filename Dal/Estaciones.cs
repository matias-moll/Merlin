...
namespace Rivn.Dal
{
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: Estaciones
    /// </summary>
    public static class Estaciones
    {
                                      ...
                                      ref StatMsg p_smResult)
        {
            ...
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Rivn..ESTACIONES_CHKVERSION",
                               new DbParameter[] {
                                     ...
                                     ref StatMsg p_smResult)
        {
            ...
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Rivn..ESTACIONES_GETMAXKEY",
                               new DbParameter[] {
                                            ...
                                            ref StatMsg p_smResult)
        {
            ...
            try {
                ...
                p_dtResult.Columns["ets_ete_telefono"].Caption= "V1TelefonoCN1";
