...
namespace Mrln.Dal
{
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: DestinatariosMails
    /// </summary>
    public static class DestinatariosMails
    {
        //---------------------------------------------------------------
                             ...
                             ref StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec_DS(p_dbcAccess,
                                      "TNGS_Mrln..DESTINATARIOSMAILS_UP",
                                      new DbParameter[] {
                                 ...
                                 ref StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec_DS(p_dbcAccess,
                                      "TNGS_Mrln..DESTINATARIOSMAILS_SEARCH",
                                      new DbParameter[] {
                                          p_dbcAccess.MakeParam("@dem_cod_codigo", p_strCodigo),
                                          p_dbcAccess.MakeParam("@onlyactive", (p_bOnlyActive ? 1 : 0))
                                      },
                                 ...
                                 ref StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..DESTINATARIOSMAILS_INSERT",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@dem_cod_codigo", p_strCodigo),
                                       p_dbcAccess.MakeParam("@dem_des_descripcion", p_strDescripcion),
                                       p_dbcAccess.MakeParam("@dem_txt_destinatarios", p_strDestinatarios),
                                 ...
                                 ref StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..DESTINATARIOSMAILS_UPDATE",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@dem_cod_codigo", p_strCodigo),
                                       p_dbcAccess.MakeParam("@dem_des_descripcion", p_strDescripcion),
                                       p_dbcAccess.MakeParam("@dem_txt_destinatarios", p_strDestinatarios),
                                 ...
                                 ref StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..DESTINATARIOSMAILS_DELETE",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@dem_cod_codigo", p_strCodigo),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                                 ...
                                 ref StatMsg p_smResult)
        {
            try {
                // Borramos el registro
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..DESTINATARIOSMAILS_RECALL",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@dem_cod_codigo", p_strCodigo),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                               ...
                               ref StatMsg p_smResult)
        {
            try {
                // Borramos el registro
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..DESTINATARIOSMAILS_DROP",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@dem_cod_codigo", p_strCodigo),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                               ...
                               ref StatMsg p_smResult)
        {
            try {
                // Borramos el registro
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..DESTINATARIOSMAILS_PACK",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                                  );
                                            ...
                                            ref StatMsg p_smResult)
        {
            try {
                ...
                p_dtResult.Columns["dem_cod_codigo"].Caption= "V1CódigoCN1";
                p_dtResult.Columns["dem_des_descripcion"].Caption= "V1DescripciónCN1";
