...
namespace Mrln.Dal
{
    ...
    // Sistema                  : Mrln
    // Clase para Administrar   : Taller
    // Basada en la Tabla       : Taller
    //----------------------------------------------------------------------------
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: Taller
    /// </summary>
