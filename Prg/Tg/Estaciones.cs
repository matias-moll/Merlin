...
namespace Rivn.Tg
{
    ...
    public partial class Estaciones : DockContent
    {
        ...
        public Estaciones()
        {
            ...
            m_smResult= new StatMsg("Estaciones");
        ...
        private void cmdExcel_Click(object sender, System.EventArgs e)
        {
            ...
            grdDatos.ExportToExcel(false, false, "", "Estaciones", ref m_smResult);
            App.EndAdvance();
            App.HideMsg();
        }
        ...
        private void cmdPurgar_Click(object sender, EventArgs e)
        {
            ...
            Bll.Tablas.EstPurge(ref m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void cmdGrabar_Click(object sender, System.EventArgs e)
        {
            ...
            Bll.Tablas.EstSave(m_entEstacion, ref m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
        ...
        private void FillGrid()
        {
            ...
            Bel.LEEstaciones l_lentEstaciones= Bll.Tablas.EstUpFull(false, ref m_smResult);
            if (MsgRuts.AnalizeError(this, m_smResult)) return;
