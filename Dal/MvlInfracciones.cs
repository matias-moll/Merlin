...
namespace Mrln.Dal
{
    ...
    /// <summary>
    /// Modulo DAL de Acceso a la tabla: MvlInfracciones
    /// </summary>
    public static class MvlInfracciones
    {
        //---------------------------------------------------------------
                                      ...
                                      ref StatMsg p_smResult)
        {
            try {
                ...
                DBRuts.Exec_DS(p_dbcAccess,
                               "TNGS_Mrln..MVLINFRACCIONES_CHKVERSION",
                               new DbParameter[] {
                                 ...
                                 ref StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec_DS(p_dbcAccess,
                                      "TNGS_Mrln..MVLINFRACCIONES_SEARCH",
                                      new DbParameter[] {
                                          p_dbcAccess.MakeParam("@mvi_ecd_patente", p_strPatente),
                                          p_dbcAccess.MakeParam("@mvi_fyh_fecha", p_dtFecha),
                                          p_dbcAccess.MakeParam("@onlyactive", (p_bOnlyActive ? 1 : 0))
                                  ...
                                  ref StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec_DS(p_dbcAccess,
                                      "TNGS_Mrln..MVLINFRACCIONES_FSEARCH",
                                      new DbParameter[] {
                                          p_dbcAccess.MakeParam("@mvi_ecd_patente", p_strPatente),
                                          p_dbcAccess.MakeParam("@onlyactive", (p_bOnlyActive ? 1 : 0))
                                      },
                                 ...
                                 ref StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..MVLINFRACCIONES_INSERT",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@mvi_ecd_patente", p_strPatente),
                                       p_dbcAccess.MakeParam("@mvi_fyh_fecha", p_dtFecha),
                                 ...
                                 ref StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..MVLINFRACCIONES_DELETE",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@mvi_ecd_patente", p_strPatente),
                                       p_dbcAccess.MakeParam("@mvi_fyh_fecha", p_dtFecha),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                  ...
                                  ref StatMsg p_smResult)
        {
            try {
                ...
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..MVLINFRACCIONES_FDELETE",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@mvi_ecd_patente", p_strPatente),
                                 ...
                                 ref StatMsg p_smResult)
        {
            try {
                // Borramos el registro
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..MVLINFRACCIONES_RECALL",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@mvi_ecd_patente", p_strPatente),
                                       p_dbcAccess.MakeParam("@mvi_fyh_fecha", p_dtFecha),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                  ...
                                  ref StatMsg p_smResult)
        {
            try {
                // Borramos los registro de la clave foranea
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..MVLINFRACCIONES_FRECALL",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@mvi_ecd_patente", p_strPatente),
                                       p_dbcAccess.MakeParam("@instante", p_dtInstante),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                               ...
                               ref StatMsg p_smResult)
        {
            try {
                // Borramos el registro
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..MVLINFRACCIONES_DROP",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@mvi_ecd_patente", p_strPatente),
                                       p_dbcAccess.MakeParam("@mvi_fyh_fecha", p_dtFecha),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                ...
                                ref StatMsg p_smResult)
        {
            try {
                // Borramos los registro de la clave foranea
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..MVLINFRACCIONES_FDROP",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@mvi_ecd_patente", p_strPatente),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                               ...
                               ref StatMsg p_smResult)
        {
            try {
                // Borramos el registro
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..MVLINFRACCIONES_PACK",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
                                  );
                                ...
                                ref StatMsg p_smResult)
        {
            try {
                // Borramos los registro de la clave foranea
                return DBRuts.Exec(p_dbcAccess,
                                   "TNGS_Mrln..MVLINFRACCIONES_FPACK",
                                   new DbParameter[] {
                                       p_dbcAccess.MakeParam("@mvi_ecd_patente", p_strPatente),
                                       p_dbcAccess.MakeParam("@usuario", DBConn.Usuario)
                                   }
